        ...
        <div class="container mx-auto flex items-center justify-between py-4 px-6">
          <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
              ...
              <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                  <a href="/mtsputri/create" class="bg-green-500 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-white-100 hover:text-black">Daftar</a>
      ...
      <div class="container mx-auto my-4">
        ...
        <div class="flex justify-center">
            <div class="w-full max-w-2xl bg-white shadow-lg rounded-lg">
                ...
                <form enctype="multipart/form-data" action="{{ route('mtsputris.store') }}" method="post" class="p-4">
                    @csrf
                ...
                <div class="step active">
                    ...
                    <div class="mb-4">
                        <label for="nama" class="block text-lg font-medium text-gray-700">Nama Santriwati</label>
