  ...
  <body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto p-4">
        <div class="flex justify-end mb-4">
            <a href="{{ route('santris.create') }}" class="bg-gradient-to-r from-teal-400 to-teal-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-teal-300" hover:bg-gray-700">Create</a>
        </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-all duration-200">
                                    ...
                                    <td class="border px-4 py-3 text-center">
                                        <div class="flex space-x-2 justify-center">
                                            <a href="{{ route('santris.edit', $student->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-all duration-200">Edit</a>
                                        ...
                                        <form id="delete-santri-form-{{ $student->id }}" action="{{ route('santris.destroy', $student->id) }}" method="post" class="hidden">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </td>
