            ...
            <div class="bg-green-500 p-4 rounded-t-lg">
                ...
                <form id="multiStepForm" enctype="multipart/form-data" class="p-4">
                    ...
                    <div class="slide" id="slide1">
                        ...
                        <div>
                            <label for="name2">Nama ke 2:</label>
                    ...
                    {{-- <div class="mb-4">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            class="form-control w-full p-3 rounded-lg border">
                    ...
                    <br>
                    <div class="mb-4">
                        <label for="image" class="block text-lg font-medium text-gray-700">Upload Gambar (Maksimal 2MB, JPG/JPEG/PNG):</label>
                        <input
                            type="file"
                            id="image"
                            name="image"
...
<script>
    let currentSlide = 1;
            ...
            function validateSlide(slideIndex) {
                ...
                document.getElementById('nameError').innerText = '';
                document.getElementById('name2Error').innerText = '';
                document.getElementById('emailError').innerText = '';
                document.getElementById('imageError').innerText = '';
                ...
                if (slideIndex === 1) {
                    ...
                    if (!name2) {
                        document.getElementById('name2Error').innerText = 'Nama ke 2 harus diisi.';
                        isValid = false;
                    }
