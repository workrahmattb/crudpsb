                ...
                <div class="card borde-0 shadow-lg my-4">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Image2 -->
                            <div class="mb-3">
                                <label for="" class="form-label h5">Image2</label>
                                <input type="file" class="form-control form-control-lg" placeholder="Price" name="image2">

                                @if ($product->image2 != "")
                                    <img  class="w-50 my-3" src="{{ asset('uploads/products/'.$product->image2) }}" alt="">
                                @endif
                            </div>
                            <div class="d-grid">
